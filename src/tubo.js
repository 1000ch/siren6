...
itemListPush('保存の壺[0]', 800, 320);
itemListPush('保存の壺[1]', 900, 360);
itemListPush('保存の壺[2]', 1000, 400);
itemListPush('保存の壺[3]', 1100, 440);
itemListPush('保存の壺[4]', 1200, 480);
itemListPush('保存の壺[5]', 1300, 520);
itemListPush('識別の壺[0]', 800, 320);
itemListPush('識別の壺[1]', 900, 360);
itemListPush('識別の壺[2]', 1000, 400);
itemListPush('識別の壺[3]', 1100, 440);
itemListPush('識別の壺[4]', 1200, 480);
itemListPush('識別の壺[5]', 1300, 520);
itemListPush('変化の壺[0]', 800, 320);
itemListPush('変化の壺[1]', 900, 360);
itemListPush('変化の壺[2]', 1000, 400);
itemListPush('変化の壺[3]', 1100, 440);
itemListPush('変化の壺[4]', 1200, 480);
itemListPush('変化の壺[5]', 1300, 520);
itemListPush('換金の壺[0]', 1000, 400);
itemListPush('換金の壺[1]', 1100, 440);
itemListPush('換金の壺[2]', 1200, 480);
itemListPush('換金の壺[3]', 1300, 520);
itemListPush('換金の壺[4]', 1400, 560);
itemListPush('換金の壺[5]', 1500, 600);
itemListPush('合成の壺[0]', 6000, 2400);
itemListPush('合成の壺[1]', 6100, 2440);
itemListPush('合成の壺[2]', 6200, 2480);
itemListPush('合成の壺[3]', 6300, 2520);
itemListPush('合成の壺[4]', 6400, 2560);
itemListPush('おはらいの壺[0]', 1600, 640);
itemListPush('おはらいの壺[1]', 1700, 680);
itemListPush('おはらいの壺[2]', 1800, 720);
itemListPush('おはらいの壺[3]', 1900, 760);
itemListPush('おはらいの壺[4]', 2000, 800);
itemListPush('呪いの壺[0]', 1600, 640);
itemListPush('呪いの壺[1]', 1700, 680);
itemListPush('呪いの壺[2]', 1800, 720);
itemListPush('呪いの壺[3]', 1900, 760);
itemListPush('呪いの壺[4]', 2000, 800);
itemListPush('強化の壺[0]', 10000, 4000);
itemListPush('強化の壺[1]', 10100, 4040);
itemListPush('強化の壺[2]', 10200, 4080);
itemListPush('強化の壺[3]', 10300, 4120);
itemListPush('弱化の壺[0]', 10000, 4000);
itemListPush('弱化の壺[1]', 10100, 4040);
itemListPush('弱化の壺[2]', 10200, 4080);
itemListPush('弱化の壺[3]', 10300, 4120);
itemListPush('底抜けの壺[0]', 1000, 400);
itemListPush('底抜けの壺[1]', 1100, 440);
itemListPush('底抜けの壺[2]', 1200, 480);
itemListPush('底抜けの壺[3]', 1300, 520);
itemListPush('底抜けの壺[4]', 1400, 560);
itemListPush('倉庫の壺[0]', 1000, 400);
itemListPush('倉庫の壺[1]', 1100, 440);
itemListPush('倉庫の壺[2]', 1200, 480);
itemListPush('倉庫の壺[3]', 1300, 520);
itemListPush('倉庫の壺[4]', 1400, 560);
itemListPush('倉庫の壺[5]', 1500, 600);
itemListPush('手封じの壺[0]', 1000, 400);
itemListPush('手封じの壺[1]', 1100, 440);
itemListPush('手封じの壺[2]', 1200, 480);
itemListPush('手封じの壺[3]', 1300, 520);
itemListPush('手封じの壺[4]', 1400, 560);
itemListPush('手封じの壺[5]', 1500, 600);
itemListPush('割れない壺[0]', 1000, 400);
itemListPush('割れない壺[1]', 1100, 440);
itemListPush('割れない壺[2]', 1200, 480);
itemListPush('割れない壺[3]', 1300, 520);
itemListPush('割れない壺[4]', 1400, 560);
itemListPush('割れない壺[5]', 1500, 600);
itemListPush('ただの壺[0]', 800, 320);
itemListPush('ただの壺[1]', 900, 360);
itemListPush('ただの壺[2]', 1000, 400);
itemListPush('ただの壺[3]', 1100, 440);
itemListPush('ただの壺[4]', 1200, 480);
itemListPush('ただの壺[5]', 1300, 520);
itemListPush('やりすごしの壺[0]', 800, 320);
itemListPush('やりすごしの壺[1]', 900, 360);
itemListPush('やりすごしの壺[2]', 1000, 400);
itemListPush('やりすごしの壺[3]', 1100, 440);
itemListPush('やりすごしの壺[4]', 1200, 480);
itemListPush('やりすごしの壺[5]', 1300, 520);
itemListPush('背中の壺[0]', 2000, 800);
itemListPush('背中の壺[1]', 2100, 840);
itemListPush('背中の壺[2]', 2200, 880);
itemListPush('背中の壺[3]', 2300, 920);
itemListPush('背中の壺[4]', 2400, 960);
itemListPush('背中の壺[5]', 2500, 1000);
itemListPush('トドの壺[0]', 2000, 800);
itemListPush('トドの壺[1]', 2100, 840);
itemListPush('トドの壺[2]', 2200, 880);
itemListPush('トドの壺[3]', 2300, 920);
itemListPush('トドの壺[4]', 2400, 960);
itemListPush('トドの壺[5]', 2500, 1000);
itemListPush('水鉄砲の壺[0]', 2000, 800);
itemListPush('水鉄砲の壺[1]', 2100, 840);
itemListPush('水鉄砲の壺[2]', 2200, 880);
itemListPush('水鉄砲の壺[3]', 2300, 920);
itemListPush('水鉄砲の壺[4]', 2400, 960);
itemListPush('水鉄砲の壺[5]', 2500, 1000);
itemListPush('笑いの壺[0]', 2000, 800);
itemListPush('笑いの壺[1]', 2100, 840);
itemListPush('笑いの壺[2]', 2200, 880);
itemListPush('笑いの壺[3]', 2300, 920);
itemListPush('魔物の壺[0]', 2000, 800);
itemListPush('魔物の壺[1]', 2100, 840);
itemListPush('魔物の壺[2]', 2200, 880);
itemListPush('魔物の壺[3]', 2300, 920);
itemListPush('魔物の壺[4]', 2400, 960);
itemListPush('魔物の壺[5]', 2500, 1000);
itemListPush('ビックリの壺[0]', 2000, 800);
itemListPush('ビックリの壺[1]', 2100, 840);
itemListPush('ビックリの壺[2]', 2200, 880);
